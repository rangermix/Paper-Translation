...
def test_native_form_bbox_clips_invisible_content_and_records_url():
    result=inspect_pdf(ROOT/'prototype/reader/source/Efficiently-Scaling-Transformer-Inference.pdf')
...
def test_small_caps_native_regions_do_not_repeat_neighbors():
    result=inspect_pdf(ROOT/'prototype/reader/source/Pathways.pdf')
...
def test_actual_pdf_native_accents_are_not_duplicated_or_detached():
    ...
    inspection=inspect_pdf(ROOT/'prototype/reader/source/Pathways.pdf')
